# Default landing page redirects to /vqa_post
...
REDIRECT_URI =  "https://wipgenai.lwpcoe.com/vqa_post/login"
...
@app.route('/vqa_post/upload', methods=['GET', 'POST'])
@login_required
def upload_audio():
...
@app.route('/vqa_post/send_notification_mail', methods=['POST'])
@login_required
...
@app.route('/vqa_post/team')
def team():
    return render_template('team.html')
@app.route('/vqa_post/faq')
@login_required
def faq():
    return render_template('faq.html', user=session.get("user"))
@app.route('/vqa_post/sync_cloud', methods=['POST'])
@login_required
def sync_cloud():
...
@app.route('/vqa_post/call/<call_id>')
@login_required
...
@app.route('/vqa_post/sync_local', methods=['POST'])
@login_required
def sync_local():
...
@app.route('/vqa_post/get_sync_status', methods=['GET'])
@login_required
def get_sync_status():
    status = get_sync_job_status()
    return jsonify(status)

@app.route('/vqa_post/set_sync_interval', methods=['POST'])
@login_required
...
@app.route('/vqa_post/list_call_ids', methods=['GET'])
@login_required
def list_call_ids():
